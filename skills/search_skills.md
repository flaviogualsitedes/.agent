...
1. **Verificação Local:** Procure na pasta de skills do projeto atual (geralmente `.agent/skills/` ou no diretório configurado do Obsidian `00_Global/code_snippets/`) se já existe alguma habilidade que cubra o caso.
...
```bash
automatize-agent install <nome_da_skill>
```
